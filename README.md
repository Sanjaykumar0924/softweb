        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(0,0,0,0.75),rgba(104, 102, 214, 0.75)),url('web.jpg');
...
<body>
    ...
    <footer>
        <center> Designed and Developed by VEDHASHREE </center>
    </footer>
</body>
</html>
```
...
<body>
    <div class="banner">
        ...
        <div class="image">
            <table cellspacing="20"> 
                <tr align="center">
                    <td> <img src="VEDHA PIC.jpg  "> </td>
                    <td> <img src="sundar.jpeg "> </td>
                    <td> <img src="steve.jpg "> </td>
                    <td> <img src="elon.jpeg "> </td>
    ...
    <footer>
        <center> Designed and Developed by VEDHASHREE (23011692) </center>
    </footer>
</body>
</html>
```
    ...
    <div class="banner">
        ...
        <div class="navbar">
            ...
            <ul>
                ...
                <li><a href="http://127.0.0.1:8000/static/product.html"> Products </a></li>
                <li><a href="http://127.0.0.1:8000/static/person.html"> People </a></li>
                <li><a href="http://127.0.0.1:8000/static/contact.html" class="bg-contact"> Contact Us </a></li>
            </ul>
            <form action="" method="get">
                <input type="text" placeholder="Enter to Search">
                <button type="submit"> Search </button>
...
## OUTPUT:
![Screenshot 2024-05-07 225440](https://github.com/Sanjaykumar0924/softweb/assets/144149258/b2af0329-b22c-45db-84e8-d86027a3e2a2)
![Screenshot 2024-05-07 225526](https://github.com/Sanjaykumar0924/softweb/assets/144149258/9c0a3b00-69d5-4b2e-bcef-d386a98a6a1b)


![Screenshot 2024-05-07 225544](https://github.com/Sanjaykumar0924/softweb/assets/144149258/d4e8e907-933f-4329-92a6-3cbdf3b946f4)
